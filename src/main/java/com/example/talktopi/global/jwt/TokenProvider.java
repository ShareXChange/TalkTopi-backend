package com.example.talktopi.global.jwt;

import com.example.talktopi.domain.token.entity.RefreshToken;
import com.example.talktopi.domain.token.repository.RefreshTokenRepository;
...
public class TokenProvider {
    ...
    public String createRefreshToken(String email) {
        ...
        String refresh = Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS256, secretKey)
                .compact();
        RefreshToken token = new RefreshToken(refresh, email, REFRESH_TOKEN_VALID_TIME);
